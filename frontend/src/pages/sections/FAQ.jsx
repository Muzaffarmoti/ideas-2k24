    ...
    const [faqs, setFaqs] = useState([
        {
            ...
            answer: 'IdEEEas is a National level technical symposium organised by IEEE SIT-SB.',
            isOpen: false,
        },
        {
            id: 2,
            question: 'How many members can participate in a team?',
            answer: 'The team size depends on the type of event. Do click on the event cards for more details.',
            isOpen: false,
        },
        {
            id: 3,
            question: 'How many sub-events are there in idEEEas?',
            answer: 'There are 12 sub-events in IdEEEAs.',
            isOpen: false,
        },
        {
            id: 4,
        ...
        },
        {
            ...
            answer: 'Click on the event cards, download the brochure to know the rules and regulations.',
            isOpen: false,
        },
        {
            id: 7,
            question: 'For which events the on-spot registrations will be available?',
            answer: 'Blitz, Cnario, IdEEEas idol, Photographia, Rectifier, Robotics, trIEEEvia and Webify are the events in which on-spot registrations are available.',
            isOpen: false,
        },
        {
            id: 8,
            question: 'How do I register?',
            answer: 'Do click the desired event card, this gives you the event details. click on the register button to register.One will get the ticket through mail.',
            isOpen: false,
        },
        {
            id: 9,
            question: 'Can I rergister for multiple events?',
            answer: 'Yes.You can register for multiple events.',
            isOpen: false,
        },
        {
            id: 10,
            question: 'If I have any doubts, whom should I contact with?',
            answer: 'Do refer the contact page',
            isOpen: false,
        },
    ]);
